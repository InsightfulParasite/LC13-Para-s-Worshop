...
/obj/projectile/proc/on_hit(atom/target, blocked = 0, pierce_hit)
	...
	if(!nodamage && damage > 0 && (damage_type == BRUTE || damage_type == FIRE) && iswallturf(target_turf) && prob(75))
...
/obj/projectile/forceMove(atom/target)
	...
	generate_hitscan_tracers(impacting = FALSE)
	original_angle = angle
...
/atom/proc/fire_projectile(projectile_type, atom/target, sound, firer, list/ignore_targets = list())
	...
	bullet.AimProjectile(target, src)
	bullet.fire()
	return bullet
